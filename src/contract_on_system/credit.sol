...
contract Credit {
    ...
    function getInterval(string memory uuid) public view returns (int256, int256, int256, int256){
        if (users[uuid].status == 0) {
            return (-1, -1, -1, -1);
        }
        return (
    ...
    function getOrder(string memory uuid) public view returns (int256, int256, int256, int256){
        if (users[uuid].status == 0) {
            return (-1, -1, -1, -1);
        } else {
            return (
    ...
    function revalueByValidation(string memory uuid, int256 time, bool result, bool isTest) public {
        int256 dquality = 0;
    ...
    function divide(int256 dividee, int256 divider) public pure returns (int256){
